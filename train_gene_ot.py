...
from model import Encoder, Genetation, Model
...
if __name__ == '__main__':
    ...
    gene = Genetation(num_hidden, num_hidden, activation).to(device)
    ...
    for epoch in range(1, num_epochs + 1):
        ...
        loss = train(model, data.x, data.edge_index, edge_index2, adj, node_neighbor_cen)
        ...
        print(f'(T)|E={epoch:03d},l={loss:.4f},t={now - prev:.2f},all={now - start:.2f},'
              f'{num},{k1},{args.dataset},{learning_rate}')
        prev = now
